                    ...
                    <div class="modal-body">
                        <form>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Логін" aria-label="Username" aria-describedby="login-addon">
                            </div>

                            <div class="input-group mb-3">
                                <span class="input-group-text" id="paswword-addon"><i class="bi bi-unlock2"></i></span>
                                <input name="auth" type="text" class="form-control" placeholder="Пароль" aria-label="Username" aria-describedby="password-addon">
                            </div>
                        </form>
                    </div>
