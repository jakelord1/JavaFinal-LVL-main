...
import './Layout.css';
import Base64 from "../../shared/assets/base64/base64";
    ...
    return         <div className="modal fade" id="authModal" tabIndex="-1" aria-labelledby="authModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                ...
                <div className="modal-header">
                    <h1 className="modal-title fs-5" id="authModalLabel">Вход на сайт</h1>
                ...
                <div className="modal-body">
                    <form onSubmit={onAuthSubmit} id="auth-form">
                        <div className="input-group mb-3">
                            ...
                            <input name="auth-login" type="text" className="form-control" placeholder="Логин" aria-label="Логін" aria-describedby="login-addon"/>
                        </div>
